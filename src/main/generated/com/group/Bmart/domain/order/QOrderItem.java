...
public class QOrderItem extends EntityPathBase<OrderItem> {
    ...
    private static final long serialVersionUID = 1591758025L;
    ...
    public final com.group.Bmart.domain.item.QItem item;
    ...
    public QOrderItem(Class<? extends OrderItem> type, PathMetadata metadata, PathInits inits) {
        ...
        this.item = inits.isInitialized("item") ? new com.group.Bmart.domain.item.QItem(forProperty("item"), inits.get("item")) : null;
